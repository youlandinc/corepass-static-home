...
const ProductIndicator: FC<ProductIndicatorProps> = ({
  ...
  return (
    ...
    >
      ...
      <Image src={activeIcon} alt="" quality={100} sizes="16px" unoptimized />
    ...
    >
      ...
      <Container className="relative">
        <div className="md:mx-auto md:text-center xl:max-w-none">
          <p className="mx-auto mt-6 max-w-[700px] text-[clamp(14px,1.04vw,20px)] leading-6 font-semibold tracking-tight text-blue-600 italic">
            The Corepass AI platform
          </p>
          <h2 className="mx-auto mt-6 font-display text-[clamp(24px,2.5vw,48px)] font-medium tracking-tight">
            One Platform, Three Powerful Solutions
          </h2>
          <p className="mx-auto mt-6 max-w-[700px] pb-12 text-[clamp(14px,1.04vw,20px)] leading-6 tracking-tight">
